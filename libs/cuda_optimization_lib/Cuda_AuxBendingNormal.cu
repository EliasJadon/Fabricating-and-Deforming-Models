...
//}
//
//Cuda_AuxBendingNormal::Cuda_AuxBendingNormal(const Cuda::PenaltyFunction type, const int numF, const int numV, const int numH) {
...
//	FreeMemory(weight_PerHinge);
//	FreeMemory(Sigmoid_PerHinge);
